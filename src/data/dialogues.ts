  ...
  nodes: {
    ...
    hub: {
      ...
      choices: [
        ...
        { text: 'Get me registered.', goto: 'register', advances: true, showIf: { flag: 'carl:registered', not: true } },
        { text: 'About the cat...', goto: 'cat', advances: true, showIf: { flag: 'carl:registered' }, once: true },
        { text: "We're heading out.", goto: 'warning', advances: true, showIf: { flag: 'act1:party_formed' } },
  ...
  nodes: {
    ...
    hub: {
      ...
      choices: [
        ...
        { text: 'The patrol looks jumpy.', goto: 'patrol', advances: true, showIf: { flag: 'goblin:covered', not: true }, once: true },
        { text: 'Why talk to me at all?', goto: 'why', once: true },
        { text: 'Got a spark on you?', goto: 'spark', advances: true, showIf: { flag: 'goblin:striker_given', not: true } },
  ...
  nodes: {
    ...
    hub: {
      ...
      choices: [
        ...
        { text: 'Train with us. We hit it together.', goto: 'recruit', advances: true, showIf: { flag: 'ally:brandon', not: true } },
  ...
  nodes: {
    ...
    hub: {
      ...
      choices: [
        ...
        { text: 'Will you fight with us?', goto: 'recruit', advances: true, showIf: { flag: 'ally:chris', not: true } },
  ...
  nodes: {
    ...
    hub: {
      ...
      choices: [
        ...
        { text: 'We could use you on the raid.', goto: 'recruit', advances: true, showIf: { flag: 'ally:yolanda', not: true } },
  ...
  nodes: {
    ...
    hub: {
      ...
      choices: [
        ...
        { text: 'Fight beside us at the ring.', goto: 'recruit', advances: true, showIf: { flag: 'ally:imani', not: true } },
  ...
  nodes: {
    ...
    hub: {
      ...
      choices: [
        ...
        { text: 'We will guard your cart during the raid.', goto: 'promise', advances: true, showIf: { flag: 'agatha:cart_promised', not: true } },
