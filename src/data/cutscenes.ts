...
const act1Intro: CutsceneDef = {
  ...
  actions: [
    ...
    describe('This is Carl. Late twenties, works with his hands, sleeps badly. Ten minutes ago he was on the couch. Now he is on the sidewalk in boxer shorts, a winter jacket, and a pair of pink Crocs that belong to an ex-girlfriend who is out of the country.'),
    ...
    announce('GOOD MORNING, EARTH. THIS IS A COURTESY ANNOUNCEMENT. Your planet has been purchased for mineral development by the Valtay Syndicate. Your species filed no objection, largely because your species was not asked.'),
...
const act1Descent: CutsceneDef = {
  ...
  actions: [
    ...
    announce('For our new viewers joining from seventeen star systems: here is the arrangement. The Valtay Syndicate owns the dirt. The Borant Corporation produces the show that pays for digging it up. And the show, dear viewers, is THIS - the galaxy\'s most-watched survival program, filmed live inside the largest dungeon ever constructed, starring everyone this planet had left.'),
...
const act1CharacterCreation: CutsceneDef = {
  ...
  actions: [
    ...
    announce('Let us see what the box of you contains! Species: human. Build: former line cook, current insomniac. Notable assets: good hands, worse temper, and a documented history of finishing things he starts, mostly out of spite. Footwear: FLAGGED FOR AUDIENCE ENGAGEMENT.'),
...
const act2Premiere: CutsceneDef = {
  ...
  actions: [
    ...
    announce("IT IS OPENING NIGHT, LADIES AND GENTLEBEINGS! Live from Floor One, the show you voted onto the main feed: a line cook in his ex's Crocs, a purebred princess with a spell list, and a floor that wants them both creatively dead. I have hosted nine seasons of this program and I am telling you - I have a FEELING about these two."),
    addViews(1412),
...
const act3Montage: CutsceneDef = {
  ...
  actions: [
    ...
    fadeOut(150),
    fadeIn(200),
    describe('Days compress the way they only do on camera. Calluses, drills, one shared pot of terrible coffee. A crew, assembling itself around a cook.'),
    addViews(6821),
    giveXp(350),
...
const act3Credits: CutsceneDef = {
  ...
  actions: [
    ...
    describe('Starring: a cook, a cat, and the worst game show in the galaxy.'),
